!(function (root, factory) {
  ...
  const supportsPDFs,
    ...
    isFirefoxWithPDFJS =
      -1 !== ua.indexOf("irefox") &&
      18 < parseInt(ua.split("rv:")[1].split(".")[0], 10),
    ...
    (generateEmbedElement = function (
      ...
      return (
        ...
        (targetNode.innerHTML =
          ...
          style +
          "'/>"),
        targetNode.getElementsByTagName("embed")[0]
      );
    }),
    (embed = function (url, targetSelector, options) {
      if ("string" != typeof url) return embedError("URL is not valid");
      targetSelector = void 0 !== targetSelector && targetSelector;
      const pdfOpenFragment,
        id =
          (options = void 0 !== options ? options : {}).id &&
          "string" == typeof options.id
            ? "id='" + options.id + "'"
            : "",
        page = !!options.page && options.page,
        pdfOpenParams = options.pdfOpenParams ? options.pdfOpenParams : {},
        fallbackLink = void 0 === options.fallbackLink || options.fallbackLink,
        width = options.width ? options.width : "100%",
        height = options.height ? options.height : "100%",
        assumptionMode =
          "boolean" != typeof options.assumptionMode || options.assumptionMode,
        forcePDFJS =
          "boolean" == typeof options.forcePDFJS && options.forcePDFJS,
        PDFJS_URL = !!options.PDFJS_URL && options.PDFJS_URL,
      ...
      return targetNode
        ? (page && (pdfOpenParams.page = page),
          ...
          forcePDFJS && PDFJS_URL
            ...
            : supportsPDFs || (assumptionMode && isModernBrowser && !isIOS)
            ? generateEmbedElement(
                targetNode,
                targetSelector,
                url,
            ...
            : (fallbackLink &&
              ...
              embedError("This browser does not support embedded PDFs")))
        : embedError("Target element cannot be determined");
    }),
    {
